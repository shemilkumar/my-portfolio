  ...
  return (
    ...
    >
      <div className="relative flex items-center justify-center h-auto w-36">
        ...
        <button className="absolute flex items-center justify-center w-20 h-20 font-semibold -translate-x-1/2 -translate-y-1/2 border border-solid rounded-full shadow-xl bg-dark text-light border-dark top-1/2 left-1/2 hover:bg-light hover:text-dark">
          Hire Me
        </button>
      </div>
    </motion.div>
